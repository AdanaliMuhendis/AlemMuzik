...
def music_start_panel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="Hakkında 📝", callback_data="about"),
            InlineKeyboardButton(text="🥀 𝐃𝐄𝐒𝐓𝐄𝐊 🥀", callback_data="support"),
        ],
        [InlineKeyboardButton(text="۞ Gelişmiş Özellikler ۞", callback_data="feature")],
    ]
    return buttons