...
from AlemMuzik.core.call import AlemMuzik
...
async def init():
    ...
    await AlemMuzik.start()
    await AlemMuzik.decorators()
...
if __name__ == "__main__":
    ...
    LOGGER("AlemMuzik").info("sᴛᴏᴘᴘɪɴɢ AlemMuzik! ɢᴏᴏᴅʙʏᴇ")
