...
from AlemMuzik import LOGGER, YouTube, app
...
from AlemMuzik.utils.formatters import check_duration, seconds_to_min, speed_converter
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "» Aktif Sesli Sohbet Bulunamadı...**\n\nLütfen Sesli Sohbeti Başlatınız..."
                )
        except Exception as e:
            ...
            raise AssistantErr(
                "**Asistan Sesli Sohbette Görünüyor**\n\nAlem Müzik Sistemleri Asistanın Sesli Sohbette Olduğunu Gösteriyor, Eğer Bu Sorun Devam Ediyor ise Sesli Sohbeti Tekrar Başlatınız..."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**Telegram Sunucu Hatası**\n\nLütfen Sesli Sohbeti Tekrar Başlatınız...."
            )
